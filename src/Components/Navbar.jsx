...
const Navbar = () => {
  ...
  const handleLogout = () => {
    ...
    if (window.confirm("Apakah Anda yakin ingin logout?")) {
      ...
      // Hapus juga data pengguna dari local storage jika diperlukan
      ...
      <div className="flex justify-between px-6 py-3 items-center lg:px-10 w-full">
        ...
        <div className="hidden lg:flex justify-between items-center ml-2 w-2/3">
          <div className="flex w-full justify-end">
            {!localStorage.getItem("token") && ( // Tampilkan tautan LOGIN dan REGISTER jika pengguna belum login
              <>
                <Link
            ...
            {localStorage.getItem("token") && ( // Tampilkan tautan navigasi lainnya jika pengguna sudah login
              <>
